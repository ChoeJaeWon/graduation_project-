...
FILEX_EXO = '../Data/ExogenousTime/ExogenousD_data_2016204_5min_60min_60min_8.csv' #exogenous(data 8)만 잘라낸 파일 이름(X data)
...
FC_EXO_ALLTEST = [119, 162, 110, 178,80]
...
#variable
TRAIN_NUM = 11 #traing 회수 [default 1000]
