...
def model_base(S, E, Y, DISCRIMINATOR_BA,  DISCRIMINATOR_DR):
    ...
    loss_G = -tf.reduce_mean(tf.log(Discriminator_model(layer, E[CELL_SIZE-1], DISCRIMINATOR_BA, DISCRIMINATOR_DR, True))) + DISCRIMINATOR_ALPHA * cost_MSE  # MSE 는 0~ t까지 있어봤자 같은 값이다.
...
if LATENT_VECTOR_FLAG:
    ...
    print("scalar prediction is deprecated you can see it at another directory")
