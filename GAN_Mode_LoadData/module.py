...
ADV_FC_OS_ALLTEST = [79, 35, 71, 55, 85]+[OPTIMIZED_EPOCH_FC for _ in 5]
ADV_CONV_OS_ALLTEST = [41, 55, 45, 32, 42]+[OPTIMIZED_EPOCH_CONV for _ in 5]
ADV_LSTM_OS_ALLTEST = [73, 57, 42, 52]#4CV까지 돌았
ADV_CONVLSTM_OS_ALLTEST = [41, 37, 66, 55, 55]+[OPTIMIZED_EPOCH_CONV_LSTM for _ in 5]
...
ADV_FC_EXO_ALLTEST = [32, 57, 36, 32, 32]+[OPTIMIZED_EPOCH_FC for _ in 5]
ADV_CONV_EXO_ALLTEST = [33,	39,	35,	32,	32]+[OPTIMIZED_EPOCH_CONV for _ in 5]
ADV_LSTM_EXO_ALLTEST = [41,	83,	41,	41,	41]+[OPTIMIZED_EPOCH_LSTM for _ in 5]
ADV_CONVLSTM_EXO_ALLTEST = [44,	61,	35,	32,	75]+[OPTIMIZED_EPOCH_CONV_LSTM for _ in 5]
