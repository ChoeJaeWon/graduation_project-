...
def MSE(y_test, y_pred):
    y_test_orig = tf.math.add(tf.math.multiply(y_test, tf.math.subtract(SPEED_MAX, SPEED_MIN)), SPEED_MIN)
    y_pred_orig = tf.math.add(tf.math.multiply(y_pred, tf.math.subtract(SPEED_MAX, SPEED_MIN)), SPEED_MIN)
